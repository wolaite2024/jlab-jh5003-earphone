...
__Vectors       DCD     __initial_sp              ; Top of Stack
                ...
                DCD     GDMA0_Channel9_Handler
                DCD     GDMA0_Channel10_Handler
                DCD     GDMA0_Channel11_Handler
                DCD     Display_Handler
                DCD     PPE_Handler
                DCD     IDU_Handler
                DCD     Slave_Port_Monitor_Handler
                DCD     RTK_Timer0_Handler
                DCD     RTK_Timer1_Handler
                DCD     RTK_Timer2_Handler
                DCD     RTK_Timer3_Handler
                DCD     CAN_Handler
                DCD     BTMAC_WRAP_AROUND_Handler
                DCD     SHA256_Handler
                DCD     Public_Key_Engine_Handler
                DCD     SPI_PHY1_INTR_Handler
...
Default_Handler PROC
                ...
                EXPORT Display_Handler        [WEAK]
                EXPORT PPE_Handler        [WEAK]
                EXPORT IDU_Handler        [WEAK]
                EXPORT Slave_Port_Monitor_Handler        [WEAK]
                EXPORT RTK_Timer0_Handler        [WEAK]
                EXPORT RTK_Timer1_Handler        [WEAK]
                EXPORT RTK_Timer2_Handler        [WEAK]
                EXPORT RTK_Timer3_Handler        [WEAK]
                EXPORT CAN_Handler        [WEAK]
                EXPORT BTMAC_WRAP_AROUND_Handler        [WEAK]
                EXPORT SHA256_Handler        [WEAK]
                EXPORT Public_Key_Engine_Handler        [WEAK]
                EXPORT SPI_PHY1_INTR_Handler        [WEAK]
