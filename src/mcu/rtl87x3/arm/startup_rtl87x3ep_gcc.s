...
g_pfnVectors:
  ...
  .word    GDMA0_Channel9_Handler
  .word    GDMA0_Channel10_Handler
  .word    GDMA0_Channel11_Handler
  .word    Display_Handler
  .word    PPE_Handler
  .word    IDU_Handler
  .word    Slave_Port_Monitor_Handler
  .word    RTK_Timer0_Handler
  .word    RTK_Timer1_Handler
  .word    RTK_Timer2_Handler
  .word    RTK_Timer3_Handler
  .word    CAN_Handler
  .word    BTMAC_WRAP_AROUND_Handler
  .word    SHA256_Handler
  .word    Public_Key_Engine_Handler
  .word    SPI_PHY1_INTR_Handler
...
*/
  ...
  .weak  Display_Handler
  .thumb_set Display_Handler,Default_Handler
  
  .weak  PPE_Handler
  .thumb_set PPE_Handler,Default_Handler
 
  .weak  IDU_Handler
  .thumb_set IDU_Handler,Default_Handler 

  .weak  Slave_Port_Monitor_Handler
  .thumb_set Slave_Port_Monitor_Handler,Default_Handler 
 
  .weak  RTK_Timer0_Handler
  .thumb_set RTK_Timer0_Handler,Default_Handler 
  
  .weak  RTK_Timer1_Handler
  .thumb_set RTK_Timer1_Handler,Default_Handler
  
  .weak  RTK_Timer2_Handler
  .thumb_set RTK_Timer2_Handler,Default_Handler 
  
  .weak  RTK_Timer3_Handler
  .thumb_set RTK_Timer3_Handler,Default_Handler
  
  .weak  CAN_Handler
  .thumb_set CAN_Handler,Default_Handler     
   
  .weak  BTMAC_WRAP_AROUND_Handler
  .thumb_set BTMAC_WRAP_AROUND_Handler,Default_Handler
  
  .weak  SHA256_Handler
  .thumb_set SHA256_Handler,Default_Handler    
  
  .weak  Public_Key_Engine_Handler
  .thumb_set Public_Key_Engine_Handler,Default_Handler          
  
  .weak  SPI_PHY1_INTR_Handler
  .thumb_set SPI_PHY1_INTR_Handler,Default_Handler      
