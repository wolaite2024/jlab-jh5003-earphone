...
/**
 * @brief 3WIRE SPI DLPS restore register.
 *
 *
 */
typedef struct
...
void SPI3WIRE_ReadBuf(uint8_t *pBuf, uint8_t readNum)
{
    ...
    {
        regVal = *((volatile uint32_t *)(&(SPI3WIRE->RD0) + (i / 4)));
        regIndex = (i % 4) * 8;
        *pBuf++ = (uint8_t)(regVal >> regIndex);
    }
}
...
uint32_t SPI2WIRE_GetDLPSBufferLen(void)
{
    return sizeof(SPI2WStoreReg_Typedef);
}
...
/**
  ...
  * @retval None
  */
void SPI2WIRE_DLPSEnter(void *peri_reg, void *p_store_buf)
{
    SPI2WStoreReg_Typedef *store_buf = (SPI2WStoreReg_Typedef *)p_store_buf;
    SPI3WIRE_TypeDef *SPI3WIREx = (SPI3WIRE_TypeDef *)peri_reg;

    store_buf->spi2w_reg = SPI3WIREx->CFGR;
...
/**
  ...
  * @retval None
  */
void SPI2WIRE_DLPSExit(void *peri_reg, void *p_store_buf)
{
    SPI2WStoreReg_Typedef *store_buf = (SPI2WStoreReg_Typedef *)p_store_buf;
    SPI3WIRE_TypeDef *SPI3WIREx = (SPI3WIRE_TypeDef *)peri_reg;

    SPI3WIREx->CFGR = store_buf->spi2w_reg;
