...
/**
 * @brief IR DLPS restore register.
 */
typedef struct
{
    uint32_t ir_reg[14];
...
uint32_t IR_GetDLPSBufferLen(void)
{
    return sizeof(IRStoreReg_Typedef);
}
...
/**
  ...
  * @retval None
  */
void IR_DLPSEnter(void *peri_reg, void *p_store_buf)
{
    IRStoreReg_Typedef *store_buf = (IRStoreReg_Typedef *)p_store_buf;
    IR_TypeDef *IRx = (IR_TypeDef *)peri_reg;
...
/**
  ...
  * @retval None
  */
void IR_DLPSExit(void *peri_reg, void *p_store_buf)
{
    IRStoreReg_Typedef *store_buf = (IRStoreReg_Typedef *)p_store_buf;
    IR_TypeDef *IRx = (IR_TypeDef *)peri_reg;
    ...
    {
        /* TX MODE NOT RESTORE TX ENABLE */
        IRx->TX_CONFIG  = (store_buf->ir_reg[1] & (~(BIT30)));
    }
