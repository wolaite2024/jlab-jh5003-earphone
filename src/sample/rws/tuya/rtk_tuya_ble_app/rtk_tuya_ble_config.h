...
#define TUYA_BLE_PORT_PLATFORM_HEADER_FILE  "rtk_tuya_ble_port_rtl8773c.h"


#define CUSTOMIZED_TUYA_BLE_APP_PRODUCT_TEST_HEADER_FILE "rtk_tuya_app_product_test.h"
...
#define TUYA_BLE_LOG_LEVEL  TUYA_BLE_LOG_LEVEL_INFO
...
/* start address */
#define TUYA_NV_START_ADDR             (APP_TUYA_FTL_START_ADDR)

/* area size. */
#define TUYA_NV_AREA_SIZE              (4*TUYA_NV_ERASE_MIN_SIZE)

/*rtk define */
/*RTK_TUYA_AES_TEST_DEMO just for test,normal version RTK_TUYA_AES_TEST_DEMO must be set to 0*/
#define RTK_TUYA_AES_TEST_DEMO         (0)
#if RTK_TUYA_AES_TEST_DEMO
#undef TUYA_BLE_DATA_MTU_MAX
#define TUYA_BLE_DATA_MTU_MAX           (0)
#endif
