...
void fe448_invert(int64_t *r, const int64_t *a)
{
    ...
    /* t4 = 1f */
    fe448_sqr(t2, t4);
    for (i = 1; i < 5; ++i) { fe448_sqr(t2, t2); }
    /* t2 = 3e0 */
    fe448_mul(t1, t2, t4);
    /* t1 = 3ff */
    fe448_sqr(t2, t1);
    for (i = 1; i < 10; ++i) { fe448_sqr(t2, t2); }
    /* t2 = ffc00 */
    fe448_mul(t1, t2, t1);
    /* t1 = fffff */
    fe448_sqr(t2, t1);
    ...
    /* t1 = 1ffffff */
    fe448_sqr(t2, t1);
    for (i = 1; i < 25; ++i) { fe448_sqr(t2, t2); }
    /* t2 = 3fffffe000000 */
    fe448_mul(t1, t2, t1);
    /* t1 = 3ffffffffffff */
    fe448_sqr(t2, t1);
    ...
    fe448_sqr(t1, t1);
    for (i = 1; i < 224; ++i) { fe448_sqr(t1, t1); }
...
void fe448_pow_2_446_222_1(int64_t *r, const int64_t *a)
{
    ...
    /* t3 = fe */
    fe448_sqr(t2, t1);
    for (i = 1; i < 7; ++i) { fe448_sqr(t2, t2); }
    /* t2 = 7f80 */
    fe448_mul(t5, t2, t5);
    /* t5 = 7fff */
    fe448_sqr(t2, t1);
    for (i = 1; i < 8; ++i) { fe448_sqr(t2, t2); }
    /* t2 = ff00 */
    fe448_mul(t1, t2, t1);
    /* t1 = ffff */
    fe448_mul(t3, t3, t2);
    /* t3 = fffe */
    fe448_sqr(t2, t5);
    for (i = 1; i < 15; ++i) { fe448_sqr(t2, t2); }
    /* t2 = 3fff8000 */
    fe448_mul(t5, t2, t5);
    /* t5 = 3fffffff */
    fe448_sqr(t2, t1);
    for (i = 1; i < 16; ++i) { fe448_sqr(t2, t2); }
    /* t2 = ffff0000 */
    fe448_mul(t1, t2, t1);
    /* t1 = ffffffff */
    fe448_mul(t3, t3, t2);
    /* t3 = fffffffe */
    fe448_sqr(t2, t1);
    for (i = 1; i < 32; ++i) { fe448_sqr(t2, t2); }
    /* t2 = ffffffff00000000 */
    fe448_mul(t2, t2, t1);
    /* t2 = ffffffffffffffff */
    fe448_sqr(t1, t2);
    for (i = 1; i < 64; ++i) { fe448_sqr(t1, t1); }
    ...
    fe448_sqr(t1, t3);
    for (i = 1; i < 192; ++i) { fe448_sqr(t1, t1); }
    ...
    fe448_sqr(t1, t1);
    for (i = 1; i < 30; ++i) { fe448_sqr(t1, t1); }
