...
**************************************************************************/
#define WaitRdyLow()                    {while(hal_gpio_get_input_level(P2_1));}

#define WaitRdyHigh()                   {while(!hal_gpio_get_input_level(P2_1));}

#define I2C_AZQ_ADDR                    0x44

#define IQS773_MODULE                   0x01
#define IQS873_MODULE                   0x02
