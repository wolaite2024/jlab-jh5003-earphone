...
*****************************************************************************************
* \file    rtl876x_keyscan_def.h
* \brief   KEYSCAN related definitions.
* \author
* \date
* \version v1.0
* *************************************************************************************
...
#ifndef RTL876X_KEYSCAN_DEF_H
#define RTL876X_KEYSCAN_DEF_H
...
typedef struct
{
    ...
    __IO uint32_t KEYSCAN_FIFO_ENTRY;           /*!< 0x14 */
    __IO uint32_t KEYSCAN_INT_MASK;             /*!< 0x18 */
    __IO uint32_t KEYSCAN_INT_CLR;              /*!< 0x1C */
    __IO uint32_t KEYSCAN_INT_STS;              /*!< 0x20 */
    __I  uint32_t RSVD0[3];                     /*!< 0x24 - 0x2C */
    __IO uint32_t KEYSCAN_DBG1;                 /*!< 0x30 */
    __IO uint32_t KEYSCAN_DBG2;                 /*!< 0x34 */
    __I  uint32_t RSVD1[2];                     /*!< 0x38 - 0x3C */
 ...
 *                          KEYSCAN Declaration
 *============================================================================*/
#define KEY_SCAN_BASE               (QDEC_BASE + 0x400)
...
/* 0x08
   ...
   10      R/W    keyscan_manual_sel              1'h0
...
/* 0x30
   31:0    R      rtl_version                     32'h20241015
*/
typedef union
{
    uint32_t d32;
