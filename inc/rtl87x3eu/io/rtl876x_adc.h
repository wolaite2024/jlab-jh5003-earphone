...
#endif
#define INTERNAL_VDDCORE_MODE         ((uint16_t)((ADC_MODE_INTERNAL_VALUE << CHIP_ADC_MODE_OFFSET) | 0x02))
#define INTERNAL_VCORE_MODE           ((uint16_t)((ADC_MODE_INTERNAL_VALUE << CHIP_ADC_MODE_OFFSET) | 0x03))
#define INTERNAL_ICHARGE_MODE         ((uint16_t)((ADC_MODE_INTERNAL_VALUE << CHIP_ADC_MODE_OFFSET) | 0x04))
#define INTERNAL_IDISCHG_MODE         ((uint16_t)((ADC_MODE_INTERNAL_VALUE << CHIP_ADC_MODE_OFFSET) | 0x05))
#define INTERNAL_ICHGM1_MODE          ((uint16_t)((ADC_MODE_INTERNAL_VALUE << CHIP_ADC_MODE_OFFSET) | 0x06))
#define INTERNAL_VDDIO_MODE           ((uint16_t)((ADC_MODE_INTERNAL_VALUE << CHIP_ADC_MODE_OFFSET) | 0x07))
...
/**
 * \defgroup    ADC_RG2X_0_Delay ADC RG2X_0 Delay Time
 * \{
 * \ingroup     ADC_Exported_Constants
 */
typedef enum
...
#define IS_ADC_RG2X_0_DELAY_TIME(TIME) (((TIME) == ADC_POW_AD1_DELAY_10_US) || \
                                        ...
                                        ((TIME) == ADC_POW_AD1_DELAY_80_US))

/** End of ADC_RG2X_0_Delay
  * \}
  */

/**
 * \defgroup    ADC_RG0X_1_Delay ADC RG0X_1 Delay Time
 * \{
 * \ingroup     ADC_Exported_Constants
 */
typedef enum
...
#define IS_ADC_RG0X_1_DELAY_TIME(TIME) (((TIME) == ADC_POW_AD2_DELAY_20_US) || \
                                        ...
                                        ((TIME) == ADC_POW_AD2_DELAY_160_US))

/** End of ADC_RG0X_1_Delay
  * \}
  */

/**
 * \defgroup    ADC_RG0X_0_Delay ADC RG0X_0 Delay Time
 * \{
 * \ingroup     ADC_Exported_Constants
 */
typedef enum
...
#define IS_ADC_RG0X_0_DELAY_TIME(TIME) (((TIME) == ADC_POW_REF_DELAY_30_US) || \
                                        ...
                                        ((TIME) == ADC_POW_REF_DELAY_240_US))

/** End of ADC_RG0X_0_Delay
  * \}
  */
...
typedef struct
{
    ...
    uint8_t ADC_FifoThdLevel;                       /*!< Specifies the ADC fifo threshold to trigger interrupt ADC_INT_FIFO_THD.
    ...
    FunctionalState
    ADC_TimerTriggerEn;                     /*!< Enable ADC one-shot mode when tim toggles. */
 ...
 * void adc_demo(void)
 * {
 *   ADC_SchTableConfig(ADC,0,INTERNAL_VBAT_MODE);
 * }
 * \endcode
 *
 */
