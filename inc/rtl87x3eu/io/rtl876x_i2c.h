...
typedef enum
{
    I2C_STOP_DISABLE = 0x00,
    I2C_STOP_ENABLE = 0x01,
} I2CStopBit_TypeDef;
...
#define IS_I2C_GET_FLAG(FLAG) (((FLAG) == I2C_FLAG_SLV_ACTIVITY) || ((FLAG) == I2C_FLAG_MST_ACTIVITY) || \
                               ...
                               ((FLAG) == I2C_FLAG_SLV_HOLD_RX_FIFO_FULL))
...
/**
 * \defgroup    I2C_Clock_Div I2C Clock Div
 * \{
 * \ingroup     I2C_Exported_Constants
 */
 ...
 *          This parameter can be one of the following values:
 *          \arg I2C_FLAG_SLV_HOLD_RX_FIFO_FULL: Indicates the BUS Hold in Slave mode due to the Rx FIFO being Full and an additional byte being received.
 *          \arg I2C_FLAG_SLV_HOLD_TX_FIFO_EMPTY: Indicates the BUS Hold in Slave mode for the Read request when the Tx FIFO is empty.
 *          \arg I2C_FLAG_MST_HOLD_RX_FIFO_FULL:  Indicates the BUS Hold in Master mode due to Rx FIFO is Full and additional byte has been received.
 *          \arg I2C_FLAG_MST_HOLD_TX_FIFO_EMPTY:  indicates the BUS hold when the master holds the bus because of the Tx FIFO being empty.
 ...
 * \param[in] I2Cx: Select the I2C peripheral. \ref I2C_Declaration
 * \param[in] I2C_IT: This parameter can be one of the following values:
 *            \arg I2C_INT_MST_ON_HOLD: Indicates whether master is holding the bus.
 *            \arg I2C_INT_GEN_CALL: Set only when a General Call address is received and it is acknowledged.
 *            \arg I2C_INT_START_DET: Indicates whether a START or RESTART condition has occurred on the I2C
 ...
 * \param   I2Cx: Select the I2C peripheral. \ref I2C_Declaration
 * \param   NewState: New state of the holding bus function.
 *          This parameter can be: ENABLE or DISABLE.
 * \return None.
 *
 * <b>Example usage</b>
