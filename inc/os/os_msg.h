...
/** @addtogroup OS_Message Message Queue
...
/** @defgroup OS_Message_Exported_functions Message Queue Exported Functions
 * @{
 */
...
/** @} */ /* End of group OS_Message_Exported_Functions */
/** @} */ /* End of group OS_Message */
