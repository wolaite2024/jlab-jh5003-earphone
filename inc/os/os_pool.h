...
/**
 * \addtogroup    OS_Pool    Pool Management
 *
...
/** @defgroup OS_Pool_Exported_Types Pool Management Exported Types
 * @{
 */
...
/** @defgroup OS_Pool_Exported_functions Pool Management Exported Functions
 * @{
 */

bool os_pool_create_intern(uint8_t *p_handle, T_OS_MEM_TYPE ram_type, uint16_t buf_size,
 ...
 * \arg \c      OS_MEM_TYPE_DATA    Data ON RAM type.
 * \arg \c      OS_MEM_TYPE_DATA   Data OFF RAM type.
 * \arg \c      OS_MEM_TYPE_BUFFER  BUFFER ON RAM type.
 * \arg \c      OS_MEM_TYPE_BUFFER BUFFER OFF RAM type.
 *
 ...
 *     if (os_pool_create(&handle, OS_MEM_TYPE_DATA, BUF_SIZE, BUF_NUM) == true)
 *     {
 ...
 *
 *     // Create a memory pool capable of containing 16 buffers.
 *     if (os_pool_create(&handle, OS_MEM_TYPE_DATA, BUF_SIZE1, BUF_NUM1) == true)
 *     {
 *         // Memory pool created successfully.
 *     }
 *     else
