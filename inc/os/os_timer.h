...
/**
 * \addtogroup    OS_Timer   Timer Management
 *
...
/** @defgroup OS_Timer_Exported_functions Timer Management Exported Functions
 * @{
 */
...
bool os_timer_pend_function_call(void (*p_pend_function)(void *, uint32_t), void *pvParameter1,
                                 uint32_t ulParameter2);
bool os_timer_get_timer_number(void **pp_handle, uint8_t *p_timer_number);
bool os_timer_is_timer_active(void **pp_handle);
bool os_timer_get_auto_reload(void **pp_handle, long *p_autoreload);
bool os_timer_get_next_timeout_item(void **pxListItem, unsigned long *puxListNum,
                                    uint8_t xListType);
bool os_timer_reset(void **pp_handle, uint32_t xTicksToWait);

/** @} */ /* End of group OS_Timer_Exported_Functions */
/** @} */ /* End of group OS_Timer */
