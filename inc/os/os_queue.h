...
/**
 * \addtogroup    OS_Queue   List Queue
 *
...
/** @defgroup OS_Queue_Exported_Types List Queue Exported Types
 * @{
 */
...
/** End of group OS_Queue_Exported_Types
  * @}
  */
...
/** @defgroup OS_Queue_Exported_functions List Queue Exported Functions
 * @{
 */
