...
/**
 * \defgroup    OS_Trace ISR trace Management
 *
 ...
 * \ingroup  OS_Trace
 */
bool os_trace_isr_create(void **pp_handle, const char *p_name, uint32_t priority);
 ...
 * \ingroup  OS_Trace
 */
bool os_trace_isr_begin(void *pp_handle);
