...
/**
 * \addtogroup    OS_Schedule    Kernel Scheduler
 *
...
/** @defgroup OS_Schedule_Exported_functions Kernel Scheduler Exported Functions
 * @{
 */
...
bool os_sched_in_restore(void);

/** @} */ /* End of group OS_Schedule_Exported_Functions */
/** @} */ /* End of group OS_Schedule */
