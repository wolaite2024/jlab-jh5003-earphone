...
#define GAP_ADTYPE_ENCRYPTED_ADV_DATA           0x31 //!< Encrypted Advertising Data
#define GAP_ADTYPE_PA_RESPONSE_TIMING_INFO      0x32 //!< Periodic Advertising Response Timing Information
#define GAP_ADTYPE_ELECTRONIC_SHELF_LABEL       0x34 //!< Electronic Shelf Label
...
typedef enum
{
    ...
    GAP_PERIODIC_ADV_REPORT_DATA_STATUS_FAILED    = 0xFF, /**< Failed to receive an AUX_SYNC_SUBEVENT_IND PDU. */
...
/** @brief  Definition of tx status in LE Periodic Advertising Response Report event. */
typedef enum
{
    GAP_PERIODIC_ADV_RSP_REPORT_TX_STATUS_TRANSMITTED      = 0x00, /**< AUX_SYNC_SUBEVENT_IND packet was transmitted. */
    GAP_PERIODIC_ADV_RSP_REPORT_TX_STATUS_NOT_TRANSMITTED  = 0x01, /**< AUX_SYNC_SUBEVENT_IND packet was not transmitted. */
} T_GAP_PERIODIC_ADV_RSP_REPORT_TX_STATUS;

/** @brief  Definition of data status in LE Periodic Advertising Response Report event. */
typedef enum
{
    GAP_PERIODIC_ADV_RSP_REPORT_DATA_STATUS_COMPLETE  = 0x00, /**< Data complete. */
    GAP_PERIODIC_ADV_RSP_REPORT_DATA_STATUS_MORE      = 0x01, /**< Data incomplete, more data to come. */
    GAP_PERIODIC_ADV_RSP_REPORT_DATA_STATUS_FAILED    = 0xFF, /**< Failed to receive an AUX_SYNC_SUBEVENT_RSP PDU. */
} T_GAP_PERIODIC_ADV_RSP_REPORT_DATA_STATUS;
