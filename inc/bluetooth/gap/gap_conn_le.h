...
typedef enum
{
    ...
    GAP_PARAM_CONN_ADV_HANDLE      = 0x27c,//!< PAwR. Master role, used to identify an advertising set. Read only.
    GAP_PARAM_CONN_SYNC_HANDLE     = 0x27d,//!< PAwR. Slave role, used to identify the periodic advertising train. Read only.
