 ...
 * @param[in]   periodic_adv_interval_max     Maximum advertising interval for periodic advertising.
                                              ...
                                              Time Range: 7.5 ms to 81.91875 s
 * @param[in]   periodic_adv_prop             A bit field that indicates which fields should be included in the advertising packet. @ref PA_ADV_PERIODIC_ADV_PROP.
 * @param[in]   num_subevents                 Number of subevents that shall be transmitted for each periodic advertising event.
                                              Range: 0x00 to 0x80
 * @param[in]   subevent_interval             Time between the subevents of PAwR.
                                              Range: 0x06 to 0xFF
                                              Time = N x 1.25 ms
                                              Time Range: 7.5 ms to 318.75 ms
                                              NOTE: subevent_interval <= periodic_adv_interval_min / num_subevents
 ...
 *
 *              NOTE: 1.This function can only be called after receiving GAP_MSG_LE_PERIODIC_ADV_SUBEVENT_DATA_REQUEST_INFO,
 ...
 * @param[in]   p_subevent_data_param    The point of subevent data parameter arrays @ref T_GAP_PAWR_SUBEVENT_DATA_PARAM
 *
 * @return GAP operation result.
 * @retval GAP_CAUSE_SUCCESS  GAP operation success.
 * @retval Others             GAP operation failure.
