...
typedef enum
{
    REMOTE_RELAY_STATUS_ASYNC_RCVD        = 0x00, /**< Local side receives an asynchronous message from remote side */
    REMOTE_RELAY_STATUS_ASYNC_LOOPBACK    = 0x01, /**< Local side receives an asynchronous loopback message from remote side */
    REMOTE_RELAY_STATUS_ASYNC_SENT_OUT    = 0x02, /**< Local side sends the asynchronous message to the transport layer */
    REMOTE_RELAY_STATUS_ASYNC_SENT_FAILED = 0x03, /**< Local side fails to send the asynchronous message to the transport layer */
    REMOTE_RELAY_STATUS_SYNC_RCVD         = 0x04, /**< Local side receives a synchronous message from remote side */
    REMOTE_RELAY_STATUS_SYNC_LOOPBACK     = 0x05, /**< Local side receives a synchronous loopback message from remote side */
    REMOTE_RELAY_STATUS_SYNC_SENT_OUT     = 0x06, /**< Local side sends the synchronous message to the transport layer */
    REMOTE_RELAY_STATUS_SYNC_SENT_FAILED  = 0x07, /**< Local side fails to send the synchronous message to the transport layer */
    REMOTE_RELAY_STATUS_SYNC_TOUT         = 0x08, /**< Local side receives a synchronous message timeout event from the transport layer */
    REMOTE_RELAY_STATUS_SYNC_EXPIRED      = 0x09, /**< Local side receives an expired synchronous message from remote side */
    REMOTE_RELAY_STATUS_SYNC_REF_CHANGED  = 0x0A, /**< Local side receives a reference changed synchronous message from remote side */
