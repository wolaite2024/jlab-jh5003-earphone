...
/**
 * \brief  Unregister SPP service.
 *
 * \xrefitem Experimental_Added_API_2_14_0_0 "Experimental Added Since 2.14.0.0" "Experimental Added API"
 *
 * \param[in]   server_chann        Local server channel.
 *
 * \return         The status of unregistering SPP service.
 * \retval true    SPP service was unregistered successfully.
 * \retval false   SPP service was failed to unregister.
 *
 * \ingroup BT_SPP
 */
