 ...
 *
 * \return          The status of de-initializing AVRCP profile.
 * \retval true     AVRCP profile was de-initialized successfully.
 * \retval false    AVRCP profile was failed to de-initialize.
 *
 * \ingroup BT_AVRCP
 */
...
/**
 * \brief  Send an addressed player change response after the CT registers notification for the event avrcp_event_addressed_player_changed.
 *
 * \xrefitem Added_API_2_13_0_0 "Added Since 2.13.0.0" "Added API"
 *
 * \param[in]  bd_addr       Remote BT address.
