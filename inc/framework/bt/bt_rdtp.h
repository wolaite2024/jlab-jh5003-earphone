 ...
 *
 * \return          The status of de-initializing RDTP profile.
 * \retval true     RDTP profile was de-initialized successfully.
 * \retval false    RDTP profile was failed to de-initialize.
 *
 * \ingroup BT_RDTP
 */
