...
typedef enum t_bt_event
{
    ...
    /**
     * \brief Indicate ACL connection BR security start \ref T_BT_EVENT_PARAM_ACL_CONN_BR_SC_START.
     */
    BT_EVENT_ACL_CONN_BR_SC_START                     = 0x1008,

    /**
     * \brief Indicate ACL connection BR security completed \ref T_BT_EVENT_PARAM_ACL_CONN_BR_SC_CMPL.
     */
...
/**
 * \brief  BT manager event parameter A2DP sniffing configure completed.
 *
 * \ingroup BT_BTM
 */
...
/**
 * \brief BT manager event parameter set link QoS complete.
 *
 * \ingroup BT_BTM
 */
...
/**
 * \brief  Set the active ACL link.
 *
 * \param[in] bd_addr   Remote BT address.
 *
 * \return          The status of setting the active ACL link.
 * \retval true     Active ACL link was set successfully.
 * \retval false    Active ACL link was failed to set.
 *
 * \ingroup BT_BTM
 */
 ...
 *
 * \param[in] bd_addr       Bluetooth device address.
 * \param[in] negotiate     Whether is to disable negotiated traffic QoS.
 *
 * \return The result of this function.
