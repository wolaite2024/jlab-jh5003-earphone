...
/** @defgroup 87x3d_DEBUG_MONITOR Debug Monitor
 ...
 *                               Constents
*============================================================================*/
/** @defgroup DEBUG_MONITOR_Exported_Constents Debug Monitor Exported Constents
  * @{
  */
...
/** @} */ /* End of group DEBUG_MONITOR_Exported_Constents */
 ...
 *             @arg DWT_DATAVSIZE_BYTE:      Detect 1 byte access
 *             @arg DWT_DATAVSIZE_HALF_WORD: Detect 2 bytes access
 *             @arg DWT_DATAVSIZE__WORD:     Detect 4 bytes access
 * @param[in] read_write_func  the detecting type of Watchpoint.
 *            the valid value are listed below:
 *             @arg DWT_FUNCTION_READ:          Detect Read access
 *             @arg DWT_FUNCTION_WRITE:         Detect Write access
 *             @arg DWT_FUNCTION_READ_OR_WRITE: Detect Read or Write access
 * @return    none
 */

static inline void watch_point_0_setting(uint32_t watch_address,
                                         uint32_t watch_size,
 ...
 * @return    none
 */
static inline void watch_point_1_setting(uint32_t watch_address,
                                         uint32_t watch_size,
                                         uint32_t read_write_func)
{
    DWT->FUNCTION1 = 0;
 ...
 * @return    none
 */
static inline void watch_point_2_setting(uint32_t watch_address,
                                         uint32_t watch_size,
                                         uint32_t read_write_func)
{
    DWT->FUNCTION2 = 0;
 ...
 * @return    none
 */
static inline void watch_point_3_setting(uint32_t watch_address,
                                         uint32_t watch_size,
                                         uint32_t read_write_func)
{
    DWT->FUNCTION3 = 0;
...
/** @} */ /* End of group 87x3d_DEBUG_MONITOR */
