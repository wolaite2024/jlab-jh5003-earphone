...
/* Bit 16 : BIT_SOC_GTIMERA_EN. 1: enable GTIMER IP and GTIMER register */
#define SYSBLK_GTIMERA_EN_Pos (16UL) /*!< Position of  */
#define SYSBLK_GTIMERA_EN_Msk (0x1UL << SYSBLK_GTIMERA_EN_Pos) /*!< Bit mask of  */

#define SYSBLK_GTIMER0_EN_Pos SYSBLK_GTIMERA_EN_Pos
#define SYSBLK_GTIMER0_EN_Msk SYSBLK_GTIMERA_EN_Msk
...
#define SYSBLK_UART1_EN_Pos (12UL) /*!< Position of . */
#define SYSBLK_UART1_EN_Msk (0x1UL << SYSBLK_LOGUART_EN_Pos) /*!< Bit mask of  */

/* Bit 5 : BIT_SOC_FLASH2_EN. 1. enable eflash controller */
...
/* Register: REG_SOC_PERI_FUNC0_EN 0x218*/
...
/* Bit 15 : BIT_PERI_I2C2_EN. 1: enable I2C1 interface */
#define SYSBLK_I2C2_EN_Pos (15UL) /*!< Position of . */
#define SYSBLK_I2C2_EN_Msk (0x1UL << SYSBLK_I2C2_EN_Pos) /*!< Bit mask of  */
...
/* Bit 7 : BIT_PERI_SPI2_EN. 1: enable SPI2 interface */
#define SYSBLK_SPI2_EN_Pos (7UL) /*!< Position of . */
#define SYSBLK_SPI2_EN_Msk (0x1UL << SYSBLK_SPI2_EN_Pos) /*!< Bit mask of  */

/* Bit 4 : BIT_PERI_UART3_EN. 1; enable UART1 interface (  Uart3) */
#define SYSBLK_UART3_EN_Pos (4UL) /*!< Position of . */
#define SYSBLK_UART3_EN_Msk (0x1UL << SYSBLK_UART3_EN_Pos) /*!< Bit mask of  */

/* Bit 1 : BIT_PERI_UART2_EN. 1; enable UART1 interface ( log Uart1) */
...
/* Register: REG_SOC_PERI_FUNC1_EN 0x21C*/
/* Description: REG_SOC_PERI_FUNC1_EN. */

/* Bit 9 : BIT_PERI_GPIOB_EN. 1: enable DW GPIO */
#define SYSBLK_GPIOB_EN_Pos  (9UL) /*!< Position of  */
#define SYSBLK_GPIOB_EN_Msk (0x1UL << SYSBLK_GPIOB_EN_Pos) /*!< Bit mask of  */

/* Bit 8 : BIT_PERI_GPIOA_EN. 1: enable DW GPIO */
#define SYSBLK_GPIOA_EN_Pos  (8UL) /*!< Position of  */
#define SYSBLK_GPIOA_EN_Msk  (0x1UL << SYSBLK_GPIOA_EN_Pos) /*!< Bit mask of  */
...
/* Register: REG_PESOC_CLK_CTRL 0x230*/
/* Description: REG_PESOC_CLK_CTRL. */

/* Bit 25 : BIT_SOC_SLPCK_GPIOA_EN */
#define SYSBLK_SLPCK_GPIOA_EN_Pos (25UL) /*!< Position of  */
#define SYSBLK_SLPCK_GPIOA_EN_Msk (0x1UL << SYSBLK_SLPCK_GPIOA_EN_Pos) /*!< Bit mask of  */

/* Bit 24 : BIT_SOC_ACTCK_GPIOA_EN */
#define SYSBLK_ACTCK_GPIOA_EN_Pos (24UL) /*!< Position of  */
#define SYSBLK_ACTCK_GPIOA_EN_Msk (0x1UL << SYSBLK_ACTCK_GPIOA_EN_Pos) /*!< Bit mask of  */

/* Bit 23 : BIT_SOC_SLPCK_GPIOB_EN */
#define SYSBLK_SLPCK_GPIOB_EN_Pos (23UL) /*!< Position of  */
#define SYSBLK_SLPCK_GPIOB_EN_Msk (0x1UL << SYSBLK_SLPCK_GPIOB_EN_Pos) /*!< Bit mask of  */

/* Bit 22 : BIT_SOC_ACTCK_GPIOB_EN */
#define SYSBLK_ACTCK_GPIOB_EN_Pos (22UL) /*!< Position of  */
#define SYSBLK_ACTCK_GPIOB_EN_Msk (0x1UL << SYSBLK_ACTCK_GPIOB_EN_Pos) /*!< Bit mask of  */

/* Bit 21 : BIT_SOC_SLPCK_TIMERB_EN */
#define SYSBLK_SLPCK_TIMERB_EN_Pos (21UL) /*!< Position of  */
#define SYSBLK_SLPCK_TIMERB_EN_Msk (0x1UL << SYSBLK_ACTCK_TIMERB_EN_Pos) /*!< Bit mask of  */

/* Bit 20 : BIT_SOC_ACTCK_TIMER_EN */
#define SYSBLK_ACTCK_TIMERB_EN_Pos (20UL) /*!< Position of  */
#define SYSBLK_ACTCK_TIMERB_EN_Msk (0x1UL << SYSBLK_ACTCK_TIMERB_EN_Pos) /*!< Bit mask of  */

/* Bit 19 : BIT_SOC_SLPCK_UART3_EN */
#define SYSBLK_SLPCK_UART3_EN_Pos (19UL) /*!< Position of  */
#define SYSBLK_SLPCK_UART3_EN_Msk (0x1UL << SYSBLK_SLPCK_UART3_EN_Pos) /*!< Bit mask of  */

/* Bit 18 : BIT_SOC_ACTCK_UART3_EN */
#define SYSBLK_ACTCK_UART3_EN_Pos (18UL) /*!< Position of  */
#define SYSBLK_ACTCK_UART3_EN_Msk (0x1UL << SYSBLK_ACTCK_UART3_EN_Pos) /*!< Bit mask of  */
...
#define SYSBLK_SLPCK_TIMERA_EN_Msk SYSBLK_SLPCK_TIMER_EN_Msk
...
#define SYSBLK_ACTCK_TIMERA_EN_Msk  SYSBLK_ACTCK_TIMER_EN_Msk

/* Bit 13 : BIT_SOC_SLPCK_LOG_UART_EN */
#define SYSBLK_SLPCK_UART1_EN_Pos (13UL) /*!< Position of  */
#define SYSBLK_SLPCK_UART1_EN_Msk (0x1UL << SYSBLK_SLPCK_UART1_EN_Pos) /*!< Bit mask of  */

/* Bit 12 : BIT_SOC_ACTCK_LOG_UART_EN */
#define SYSBLK_ACTCK_UART1_EN_Pos (12UL) /*!< Position of  */
...
/* Register: REG_PESOC_PERI_CLK_CTRL0 0x234 */
...
/* Bit 15 : BIT_SOC_SLPCK_SPI2_EN */
#define SYSBLK_SLPCK_SPI2_EN_Pos (15UL) /*!< Position of  */
#define SYSBLK_SLPCK_SPI2_EN_Msk (0x1UL << SYSBLK_SLPCK_SPI2_EN_Pos) /*!< Bit mask of  */

/* Bit 14 : BIT_SOC_ACTCK_SPI2_EN */
#define SYSBLK_ACTCK_SPI2_EN_Pos (14UL) /*!< Position of  */
#define SYSBLK_ACTCK_SPI2_EN_Msk (0x1UL << SYSBLK_ACTCK_SPI2_EN_Pos) /*!< Bit mask of  */
...
/* Bit 11 : BIT_SOC_SLPCK_I2C2_EN */
#define SYSBLK_SLPCK_I2C2_EN_Pos (11UL) /*!< Position of  */
#define SYSBLK_SLPCK_I2C2_EN_Msk (0x1UL << SYSBLK_SLPCK_I2C2_EN_Pos) /*!< Bit mask of  */

/* Bit 10 : BIT_SOC_ACTCK_I2C2_EN */
#define SYSBLK_ACTCK_I2C2_EN_Pos (10UL) /*!< Position of  */
#define SYSBLK_ACTCK_I2C2_EN_Msk (0x1UL << SYSBLK_ACTCK_I2C2_EN_Pos) /*!< Bit mask of  */
...
/* Register: REG_PESOC_COM_CLK_CTRL1 0x238*/
