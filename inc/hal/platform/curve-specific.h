...
#else
#define BYTES_TO_WORDS(a, b, c, d) 0x##a##b##c##d
#define BYTES_TO_WORDS_8(a, b, c, d, e, f, g, h) 0x##d##c##b##a, 0x##h##g##f##e
#endif
...
static const struct uECC_Curve_t curve_secp160r1 =
{
    ...
    161, /* num_n_bits */
    {
        BYTES_TO_WORDS_8(FF, FF, FF, fF, FF, FF, FF, FF),
        BYTES_TO_WORDS_8(FF, FF, FF, FF, FF, FF, FF, FF),
        BYTES_TO_WORDS(FF, FF, FF, 7F)
    },
    {
        BYTES_TO_WORDS(00, 00, 00, 01), BYTES_TO_WORDS(00, 00, 00, 00),
        BYTES_TO_WORDS(f4, 01, 00, 00), BYTES_TO_WORDS(ae, 27, f9, c8),
        BYTES_TO_WORDS(22, 75, ca, d3), BYTES_TO_WORDS(00, 00, 00, 57)
    },
    {
        BYTES_TO_WORDS(68, B5, 96, 4A), BYTES_TO_WORDS(28, 73, F5, 8E),
        BYTES_TO_WORDS(89, 69, 64, 46), BYTES_TO_WORDS(B9, 8B, C3, 68),
        BYTES_TO_WORDS(82, FC, CB, 13),

        BYTES_TO_WORDS(55, 28, A6, 23), BYTES_TO_WORDS(7D, 94, 68, 31),
        BYTES_TO_WORDS(12, C9, DC, 59), BYTES_TO_WORDS(37, 51, 23, 04),
        BYTES_TO_WORDS(32, FB, C5, 7A)
    },
    {
        BYTES_TO_WORDS(FC, BE, 97, 1C), BYTES_TO_WORDS(8B, 7A, BD, 54),
        BYTES_TO_WORDS(9F, F8, AC, 65), BYTES_TO_WORDS(AD, D4, D4, 81),
        BYTES_TO_WORDS(45, FA, 65, C5)
    },
    &double_jacobian_default,
#if uECC_SUPPORT_COMPRESSED_POINT
    &mod_sqrt_default,
